...
--
-- Host: 192.168.99.22    Database: radius
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=63235 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `radcheck` (
  ...
  `role` int(11) NOT NULL DEFAULT '2' COMMENT '0超级管理员1普通管理员2普通用户',
  PRIMARY KEY (`id`),
...
CREATE TABLE `radpostauth` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=84387 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `rmsettings`
--

DROP TABLE IF EXISTS `rmsettings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rmsettings` (
...
--
-- Table structure for table `uic`
--

DROP TABLE IF EXISTS `uic`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uic` (
  `username` varchar(255) NOT NULL,
...
-- Dump completed on 2018-06-20 14:42:43
